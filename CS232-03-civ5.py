...
os.chdir("C:/Users/Christopher/AppData/Local/Programs/Python/Python36-32")
...
def play_hangman():
    ...
    play_again = 'y'
    while play_again == 'y':
        print("Hello, please enter a letter: \n")
        new_letter = input("Letter: ")
        if new_letter in letters_guessed:
            print("This letter has already been entered, try another entry.")
            continue
        else:
        ...
        print_guessed()
        print("You have so far guessed: ",  letters_guessed)
        if word_guessed() == True:
            print("You have won! congratulations! Would you like to play again? enter y for yes all other keys exit program")
            play_again = input("Continue?").lower()
            letters_guessed = [ ]
            secret_word  = get_word()
            wrong_guesses = 0
        if wrong_guesses == 6:
            print("You have lost! the word was: ", secret_word)
            print( " Would you like to play again? enter y for yes all other keys exit program.")
            play_again = input("Continue?").lower()
            letters_guessed = [ ]
            secret_word  = get_word()
            wrong_guesses = 0
